...
# grid search 
nohup python src/train.py -m data=ccp,fr,us,nl,es model._target_=src.models.descm_cycada.MultiTaskLitModel_cycada model.model._target_=src.models.descm_cycada.DESCM_Embedding_DA_cycada model.loss._target_=src.models.common.Basic_Loss  experiment=descm_cycada_experiment test=True data.debug=False >logs/out.log 2>&1 &

# simple
nohup python src/train.py -m data=ccp,fr,us,nl,es experiment=descm_cycada_experiment test=True data.debug=False >logs/out.log 2>&1 &
