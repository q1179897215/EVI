...
# grid search 
nohup python src/train.py -m data=ccp,fr,us,nl,es model.model._target_=src.models.descm.DESCM_Embedding_DA_2_1 model.loss._target_=src.models.common.IPW_Loss experiment=descm_experiment test=True data.debug=False >logs/out.log 2>&1 &
