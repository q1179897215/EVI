...
# grid search 
nohup python src/train.py -m data=ccp,fr,us,nl,es model.model._target_=src.models.descm.ESCM,src.models.descm.DESCM_Embedding model.loss._target_=src.models.common.Basic_Loss experiment=descm_experiment test=True data.debug=False >logs/out.log 2>&1 &
