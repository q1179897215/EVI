...
nohup python src/train.py -m data=ccp,fr,us,es,nl experiment=new_experiment test=True data.debug=False trainer.max_epochs=1 trainer.min_epochs=1 model.info_layer_num=1.0,2.0,3.0,0.0 >logs/out.log 2>&1 &
