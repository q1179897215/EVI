...
nohup python src/train.py -m data=ccp experiment=new_experiment test=True data.debug=False trainer.max_epochs=1 trainer.min_epochs=1 model.info_layer_num=0.0,1.0,2.0,3.0 >logs/out.log 2>&1 &

nohup python src/train.py -m data=in experiment=new_experiment test=True data.debug=False trainer.max_epochs=1 trainer.min_epochs=1 model.loss.ctr_loss_proportion=0.2 model.info_layer_num=0.0,1.0,2.0,3.0 >logs/out.log 2>&1 &
