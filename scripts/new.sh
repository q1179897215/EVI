...
nohup python src/train.py -m data=fr,us,nl,es experiment=new_experiment test=True data.debug=False trainer.max_epochs=1 trainer.min_epochs=1 model.info_layer_num=0.0 >logs/out.log 2>&1 &
